...
int main(int argc, char* argv[])
{
 ...
 auto problem_n_1= Korali::Problem::Likelihood(likelihood_heat2D);
 auto problem_n_2= Korali::Problem::Likelihood(likelihood_heat2D);
 auto problem_n_3= Korali::Problem::Likelihood(likelihood_heat2D);


 Korali::Parameter::Uniform xpos_single("xpos_single", 0.0, 1.0);
 Korali::Parameter::Uniform ypos_single("ypos_single", 0.0, 1.0);

 Korali::Parameter::Uniform xpos_1("xpos_1", 0.0, 0.5);
 Korali::Parameter::Uniform ypos_1("ypos_1", 0.0, 1.0);

 Korali::Parameter::Uniform xpos_2("xpos_2", 0.5, 1.0);
 ...
 problem_n_1.addParameter(&xpos_single);
 problem_n_1.addParameter(&ypos_single);
